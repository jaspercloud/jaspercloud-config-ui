...
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_config_info";
CREATE SEQUENCE "public"."seq_config_info" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
CREATE TABLE "public"."config_history" (
  ...
  "group_area" varchar(255) COLLATE "pg_catalog"."default",
...
CREATE TABLE "public"."config_info" (
  "id" int8 NOT NULL DEFAULT nextval('seq_config_info'::regclass),
  "application" varchar(255) COLLATE "pg_catalog"."default",
  "group_area" varchar(255) COLLATE "pg_catalog"."default",
  "content" text COLLATE "pg_catalog"."default",
  "ver" int4 DEFAULT 0
...
-- ----------------------------
SELECT setval('"public"."seq_config_history"', 45, true);
SELECT setval('"public"."seq_config_info"', 74, true);
...
-- ----------------------------
ALTER TABLE "public"."config_info" ADD CONSTRAINT "service_config_application_namespace_key" UNIQUE ("application", "group_area");
